...
class PL_SBCMP(pl.LightningModule):
...
def SBCMP_train_and_pred(X_train, 
                         X_val, 
                         y_train, 
                         y_val,
...
#                          use_log=False, 
    ...
    model = PL_SBCMP( X = torch.tensor( np.vstack((X_train, X_val)) ),
...
def SBCMP_regression_train_and_pred(X_train, 
                                    X_val, 
                                    y_train, 
                                    y_val,
                                    batch_sim_strength=1, 
