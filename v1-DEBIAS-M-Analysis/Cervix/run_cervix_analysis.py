...
def main():
    ...
    for task in task_mapping_dict:
        ...
        conqur = pd.read_csv('../data/Cervix/conqur-out.csv', index_col=0) 
...
#                                       sig_dict=results_dict['is_sig'])
        ...
        plsda_clr=pd.read_csv('../data/Cervix/CLR-PLSDAbatch_out.csv', index_col=0)
